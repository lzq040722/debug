...
def _parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="The file of the init video for SDEdit. Default None.")
    parser.add_argument(
        "--sdedit_strength",
        type=float,
        default=1.0,
        help="SDEdit strength in [0, 1]. 1.0 disables init video SDEdit.")
    parser.add_argument(
        "--src_mask",
        type=str,
        default=None,
...
def generate(args):
    ...
    if "t2v" in args.task or "t2i" in args.task:
        ...
        if args.init_video is not None:
            init_video, _, _, _ = wan_vace.vid_proc.load_video(args.init_video)
            init_video = init_video.to(device)

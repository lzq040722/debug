...
class CogVideoXDDIMScheduler(SchedulerMixin, ConfigMixin):
    ...
    def set_timesteps(self, num_inference_steps: int = None, timesteps: List[int] = None, device: Union[str, torch.device] = None):
        """
        ...
        """
        self.num_inference_steps = num_inference_steps or len(timesteps)
        ...
        if timesteps is not None:
            ...
            # print("timesteps printing in scheduler:", timesteps)
            # print("timesteps length printing in scheduler:", len(timesteps))
        else:
    ...
    def step(
        ...
        if step_ratio > 0:
            prev_timestep = timestep - int(step_ratio)
        else:
